...
#import <UIKit/UIKit.h>
 ...
 FOUNDATION_EXPORT NSString * const LocalNotificationRouterUrl;

typedef void(^LocalNotificationCompletionBlock)(BOOL localNotificationsuccess);
 ...
 *		NSString *routerUrlString = [[Router sharedInstance] urlStringForRouteKey:@"productdetail" andParams:routerParam];
 *
 * 		[LocalNotification createLocalNotificationWithName:kDailyBuyLocalNotificationName 

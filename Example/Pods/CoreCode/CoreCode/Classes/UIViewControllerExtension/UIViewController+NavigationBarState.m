...
NSString *const PBNavigationBarUtilityKey = @"PBNavigationBarUtilityKey";
...
- (void)stashNavigationBarAttribute {
    ...
    [self setAssociatedObject:attribute forKey:PBNavigationBarUtilityKey policy:PBAssociationPolicyRetainNonatomic];
}
...
- (void)restoreNavigationBarAttribute {
    ...
    NSDictionary *attribute = [self getAssociatedObjectForKey:PBNavigationBarUtilityKey];
    if (attribute) {
        UINavigationBar *bar = self.navigationController.navigationBar;
...
- (void)removeStashedNavigationBarAttribute {
    [self removeAssociatedObjectForKey:PBNavigationBarUtilityKey];
}

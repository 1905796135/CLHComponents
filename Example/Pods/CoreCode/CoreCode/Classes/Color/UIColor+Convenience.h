...
typedef NS_ENUM(NSInteger, ColorDirection) {
    ColorDirectionLevel,//水平渐变
    ColorDirectionVertical,//竖直渐变
    ColorDirectionUpwardDiagonalLine,//向下对角线渐变
    ColorDirectionDownDiagonalLine,//向上对角线渐变
};

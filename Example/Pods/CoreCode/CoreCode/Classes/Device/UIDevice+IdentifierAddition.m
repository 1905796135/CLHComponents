...
NSString *const PB_EYCHAIN_DEVICECODE_KEY = @"PB_KEYCHAIN_DEVICECODE";
...
- (NSString *)uniqueDeviceIdentifier {
    NSString *code = nil;
    NSString *keyChain_deviceCode = [CoreKeychain getKeychainValueForType:PB_EYCHAIN_DEVICECODE_KEY];
    if (keyChain_deviceCode == nil || keyChain_deviceCode.length < 10) {  // 若keychain里面没有或者长度因为什么原因很短的话，重新获取一次再储存
        ...
        [CoreKeychain setKeychainValue:code forType:PB_EYCHAIN_DEVICECODE_KEY];
    } else {

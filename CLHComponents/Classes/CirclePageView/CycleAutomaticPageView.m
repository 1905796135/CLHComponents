...
@interface CycleAutomaticPageView ()
...
@implementation CycleAutomaticPageView
...
{
	BasePageControl *pageControl = [[BasePageControl alloc] init];

	if (self.pageControl) {
		[self.pageControl removeFromSuperview];
	}
    pageControl.borderColor = hex(0xB2B2B2);
...
- (void)autoCyclePageView:(NSTimer *)timer
{
    ...
    if (_mode == KCycleAutomaticPageViewLandscape) {
...
-(void)scrollViewDidEndDecelerating:(UIScrollView *)aScrollView
{
    ...
    if (_mode == KCycleAutomaticPageViewPortrait) {

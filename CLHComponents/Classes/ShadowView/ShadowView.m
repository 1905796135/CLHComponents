...
- (void)_setShadowWith:(YCShadowSide)shadowSide {
    ...
    if (shadowSide & YCShadowSideTop) {
        ...
        shadowLayer.frame = CGRectMake(0, 0, self.bounds.size.width, self.bounds.size.height*0.5);
        ...
        shadowLayer.frame = CGRectMake(0, 0, self.bounds.size.height*0.5, self.bounds.size.height);
        [path moveToPoint:CGPointMake(self.bounds.size.width*0.5, self.bounds.size.height*0.5)];
        [path addLineToPoint:(CGPointMake(0, 0))];
        [path addLineToPoint:(CGPointMake(0, self.bounds.size.height))];
    } else if (shadowSide & YCShadowSideRight) {
        shadowLayer = self.rightShadowLayer;
        shadowLayer.frame = CGRectMake(self.bounds.size.width*0.5, 0, self.bounds.size.width*0.5, self.bounds.size.height);
        [path moveToPoint:CGPointMake(0, self.bounds.size.height*0.5)];
        [path addLineToPoint:(CGPointMake(self.bounds.size.width*0.5, 0))];
        [path addLineToPoint:(CGPointMake(self.bounds.size.width*0.5, self.bounds.size.height))];
    } else if (shadowSide & YCShadowSideBottom) {
        shadowLayer = self.botShadowLayer;
        shadowLayer.frame = CGRectMake(0, self.bounds.size.height*0.5, self.bounds.size.width, self.bounds.size.height*0.5);
